...
const SignUp = () => {
    ...
    useEffect(() => {
      ...
      return(
        <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex  min-h-screen py-4 justify-center ">
        <div className="bg-[#BFC0C0] mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md">
          <h1
          ...
          >
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <div className="flex flex-col sm:flex-1">
                ...
                <input
                  ...
                  className="text-[16px] py-2 bg-transparent border-b-[1px] border-b-stone-500 focus:outline-none placeholder-gray-500"
                />
              </div>
            </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4 ">
                  ...
                  >
                    ...
                    <option value="BOB">Bank of Barodra</option>
                  ...
                  <input
                    ...
                    className="text-[16px]  py-2 bg-transparent border-b-[1px] border-b-stone-500 focus:outline-none sm:flex-1 placeholder-gray-500"
                  />
                  <input
                    type="text"
            ...
            <button
              className="bg-[#2D3142] w-[420px] font-semibold hover:bg-[#A7D532] transition-all duration-300 text-xl py-2 px-4 rounded-md text-white mx-auto lg:w-[640px] my-4"
              type="submit"
              disabled={loading}
            >
              {loading && "Registering..."}
